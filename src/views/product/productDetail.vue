...
export default {
  ...
  metaInfo: {
    title: '9能金科款_住房公积金贷款条件_银行贷款需要哪些条件找9能金科款',
    meta: [{
      name: 'keyWords',
      ...
      name: 'description',
      content: '9能金科款联合各类大型的金融机构,深度挖掘安全的金融服务渠道机构,为用户提供安全、多元的贷款产品和定制化的专业资金服务,打造更契合用户自身需求的贷款管理方案.找贷款,找信贷经理,找机构,办理贷款上9能金科款;放款快,利率低0.35%,额度高,门槛低,渠道广.小额贷款公司成立条件,银行小额贷款条件,信用社小额贷款条件,信用社个人贷款条件,招行个人贷款条件,无抵押个人贷款条件,个人住房贷款条件,农业贷款条件,贷款条件,公积金贷款 条件,贷款的条件,贷款要什么条件'
    }]
  },
  filters: {
    textFilter(val) {
