  ...
  <div>
    <div class="resource mb24">
      ...
      <div class="table-wrap">
        ...
        <el-table v-loading="listLoading" :data="tableData" element-loading-text="数据正在加载中..." element-loading-spinner="el-icon-loading" element-loading-background="rgba(0, 0, 0, 0.5)">
