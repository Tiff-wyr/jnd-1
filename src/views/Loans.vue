...
export default {
  ...
  metaInfo: {
    ...
    meta: [{
      name: 'keyWords',
      content: '贷款,买房贷款,住房贷款,组合贷款,买车贷款,助学贷款,商业贷款,信用贷款,网上贷款,按揭贷款,装修贷款,小额贷款,按揭贷款,创业贷款,个人贷款,过桥贷款,北京贷款,二手房贷款,二手车贷款,住房公积金贷款,公积金贷款,大学生创业贷款,9能金科款'
    }, {
      name: 'description',
      content: '9能金科款联合各类大型的金融机构,深度挖掘安全的金融服务渠道机构,为用户提供安全、多元的贷款产品和定制化的专业资金服务,打造更契合用户自身需求的贷款管理方案.买房抵押贷款,房屋抵押贷款,房产抵押贷款,汽车抵押贷款,汽车抵押不压车,无抵押贷款.'
    }]
  },
  components: {
    footerSame,
