...
export default {
  ...
  metaInfo: {
    ...
    meta: [{
      ...
      name: 'description',
      content: '9能金科联合各类大型的金融机构,深度挖掘安全的金融服务渠道机构,为用户提供安全、多元的贷款产品和定制化的专业资金服务,打造更契合用户自身需求的贷款管理方案.办理银行贷款流程,银行贷款办理流程,银行贷款办理条件,银行办理贷款时间,贷款如何办理,怎么办理贷款,银行贷款怎么办理,如何办理抵押贷款,公积金贷款怎么办理,买房怎么办理贷款,怎么办理信用卡贷款,如何办理公积金贷款,银行贷款怎么办理.'
    }]
  },
  components: {
    footerSame,
