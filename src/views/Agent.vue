...
export default {
  name: 'Agent',
  metaInfo: {
    title: '贷款_贷款办理_房子办贷款_办抵押贷款_办理公积金贷款_贷款申请9能贷款',
    meta: [{
      name: 'keyWords',
      ...
      name: 'description',
      content: '9能贷款联合各类大型的金融机构,深度挖掘安全的金融服务渠道机构,为用户提供安全、多元的贷款产品和定制化的专业资金服务,打造更契合用户自身需求的贷款管理方案.贷款办理条件,信用贷款办理条件,办理贷款时间,办贷款流程,贷款办理流程,公积金贷款办理流程,组合贷款办理流程.'
    }]
  },
  filters: {
    phoneFilter(phone) {
