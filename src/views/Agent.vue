...
export default {
  ...
  metaInfo: {
    ...
    meta: [{
      name: 'keyWords',
      content: '办理贷款,贷款办卡,办贷款卡,企业办贷款,买房办贷款,车贷款办理,办小额贷款,办理贷款卡,想办理贷款,小额贷款办理,信用办理贷款,办理抵押贷款,房产证办贷款,办理贷款公司,公司办理贷款,办理按揭贷款,按揭贷款办理,办理装修贷款,办理买车贷款,买车办理贷款,办理信用贷款,办理商业贷款,网上办理贷款,个人贷款办理,公积金贷款办理,大学生贷款办理,信用卡办理贷款'
    }, {
      name: 'description',
      content: '9能金科款联合各类大型的金融机构,深度挖掘安全的金融服务渠道机构,为用户提供安全、多元的贷款产品和定制化的专业资金服务,打造更契合用户自身需求的贷款管理方案.贷款办理条件,信用贷款办理条件,办理贷款时间,办贷款流程,贷款办理流程,公积金贷款办理流程,组合贷款办理流程.'
    }]
  },
  filters: {
    phoneFilter(phone) {
